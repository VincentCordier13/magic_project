...
class ShopMapWidget extends StatefulWidget {
  ...
  const ShopMapWidget({Key key, this.viewmodel}) : super(key: key);@override
...
class _ShopMapWidgetState extends State<ShopMapWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    widget.viewmodel.shops.forEach((shop) { 
      _markers.add(
        new Marker(
          width: 50.0,
          height: 50.0,
          ...
          builder: (context) => GestureDetector(
            ...
            onTap: () {
              print(shop.id);
              widget.viewmodel.shopSelection(shop);
              setState(() {
                ...
                child: Stack(
                  children: [
                    Column(
                      ...
                      children: [
                        Expanded(child: Image.asset(widget.viewmodel.shopSelected.photo)),
                        Text(widget.viewmodel.shopSelected.name, textAlign: TextAlign.center, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                        Text(widget.viewmodel.shopSelected.address, textAlign: TextAlign.center, style: TextStyle(fontSize: 16, fontWeight: FontWeight.normal),),
                      ]
                    ),
                    Container(
